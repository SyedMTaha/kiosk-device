  ...
  return (
    ...
    <div className="h-screen w-full flex flex-col bg-gradient-to-br from-blue-50 to-purple-50">
      ...
      <div className="flex justify-center items-center gap-16 mt-12">
        {/* MacOS Card */}
         <div className="glassmorphism-card hover:shadow-xl hover:scale-105 hover:border-[#4F46E5] transition-all duration-300 border-2 border-[#1D2788] px-4 pt-2 w-[10vw] text-center rounded-md cursor-pointer" > {/* onClick={()=>{navigate('/mac-type')}} */}

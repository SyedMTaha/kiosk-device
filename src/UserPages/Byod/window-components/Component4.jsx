...
const Component4 = () => {
  return (
    ...
    <div className="md:w-1/2 w-full flex flex-col justify-center items-center space-y-8 mt-auto md:mt-0  ">
      <img src={slide4} alt="Policy Table 1" className="w-full md:w-[75%] h-auto shadow-lg" />
      <img src={slide4_2} alt="Policy Table 2" className="w-full md:w-[75%] h-auto shadow-lg " />
    </div>

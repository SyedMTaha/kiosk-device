...
import img from '../images/slide 5.png';
      ...
      <div className="w-full sm:w-[30vw] flex flex-col items-center pt-16 sm:pl-16 md:pl-20">
        <div className="flex flex-col gap-4 text-center sm:text-left text-[#000F3C]">
          ...
          <p className="text-lg sm:text-xl">
            Please enter the <span className="font-bold ">captcha</span> displayed on your screen in the provided box, then click <span className="font-bold ">"Next"</span>
          </p>
        </div>
      </div>
